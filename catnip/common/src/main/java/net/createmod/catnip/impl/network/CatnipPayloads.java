...
public final class CatnipPayloads {
	...
	// clientbound
	public static final Type<ClientboundConfigPacket> CLIENTBOUND_CONFIG = registrar.clientbound("config", ClientboundConfigPacket.STREAM_CODEC);
	...
	// serverbound
	public static final Type<ServerboundConfigPacket<?>> SERVERBOUND_CONFIG = registrar.selfHandlingServerbound("config", ServerboundConfigPacket.STREAM_CODEC);
